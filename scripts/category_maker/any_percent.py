...
def create_any_percent_savefiles():
    ...
    mss_counter = 0
    mss_file = savefile.PracticeSaveInfo(mss_requirements, p0, mss_angle, mss_position, mss_cam_pos, mss_cam_target, mss_counter, "mss", p1)
    ...
    post_mss_counter = 0
    post_mss_file = savefile.PracticeSaveInfo(post_mss_requirements, p0, post_mss_angle, post_mss_position, post_mss_cam_pos, post_mss_cam_target, post_mss_counter, "post_mss", p1)
    ...
    ff1_counter = 0
    ff1_file = savefile.PracticeSaveInfo(ff1_requirements, p0, ff1_angle, ff1_position, ff1_cam_pos, ff1_cam_target, ff1_counter, "ff1", p1)
    ...
    bombs_counter = 0
    bombs_file = savefile.PracticeSaveInfo(bombs_requirements, p0, bombs_angle, bombs_position, bombs_cam_pos, bombs_cam_target, bombs_counter, "bombs", p1)
    ...
    sail_skip_counter = 0
    sail_skip_file = savefile.PracticeSaveInfo(sail_skip_requirements, p0, sail_skip_angle, sail_skip_position, sail_skip_cam_pos, sail_skip_cam_target, sail_skip_counter, "sail_skip", p1)
    ...
    ropes_2_counter = 0
    ropes_2_file = savefile.PracticeSaveInfo(ropes_2_requirements, p0, ropes_2_angle, ropes_2_position, ropes_2_cam_pos, ropes_2_cam_target, ropes_2_counter, "ropes_2", p1)
    ...
    fh_swim_counter = 0
    fh_swim_file = savefile.PracticeSaveInfo(fh_swim_requirements, p0, fh_swim_angle, fh_swim_position, fh_swim_cam_pos, fh_swim_cam_target, fh_swim_counter, "fh_swim", p1)
    ...
    dtcs_counter = 0
    dtcs_file = savefile.PracticeSaveInfo(dtcs_requirements, p0, dtcs_angle, dtcs_position, dtcs_cam_pos, dtcs_cam_target, dtcs_counter, "dtcs", p1)
    ...
    quiver_ssff2_file = savefile.PracticeSaveInfo(quiver_ssff2_requirements, p0, quiver_ssff2_angle, quiver_ssff2_position, quiver_ssff2_cam_pos, quiver_ssff2_cam_target, quiver_ssff2_counter, "quiver_ssff2", p1)
    ...
    ff2_swim_counter = 0
    ff2_swim_file = savefile.PracticeSaveInfo(ff2_swim_requirements, p0, ff2_swim_angle, ff2_swim_position, ff2_swim_cam_pos, ff2_swim_cam_target, ff2_swim_counter, "ff2_swim", p1)
    ...
    helmaroc_skip_file = savefile.PracticeSaveInfo(helmaroc_skip_requirements, p0, helmaroc_skip_angle, helmaroc_skip_position, helmaroc_skip_cam_pos, helmaroc_skip_cam_target, helmaroc_skip_counter, "helm_skip", p1)
    ...
    barrier_skip_file = savefile.PracticeSaveInfo(barrier_skip_requirements, p0, barrier_skip_angle, barrier_skip_position, barrier_skip_cam_pos, barrier_skip_cam_target, barrier_skip_counter, "bs", p1)
    ...
    trials_skip_file = savefile.PracticeSaveInfo(trials_skip_requirements, p0, trials_skip_angle, trials_skip_position, trials_skip_cam_pos, trials_skip_cam_target, trials_skip_counter, "trials_skip", p1)
    ...
    las_counter = 0
    las_file = savefile.PracticeSaveInfo(las_requirements, p0, las_angle, las_position, las_cam_pos, las_cam_target, las_counter, "las", p1)
    ...
    pgcs_counter = 0
    pgcs_file = savefile.PracticeSaveInfo(pgcs_requirements, p0, pgcs_angle, pgcs_position, pgcs_cam_pos, pgcs_cam_target, pgcs_counter, "pgcs", p1)
    ...
    pg_skip_counter = 0
    pg_skip_file = savefile.PracticeSaveInfo(pg_skip_requirements, p0, pg_skip_angle, pg_skip_position, pg_skip_cam_pos, pg_skip_cam_target, pg_skip_counter, "pg_skip", p1)
    ...
    pg_fight_counter = 0
    pg_fight_file = savefile.PracticeSaveInfo(pg_fight_requirements, p0, pg_fight_angle, pg_fight_position, pg_fight_cam_pos, pg_fight_cam_target, pg_fight_counter, "pg", p1)
    ...
    morth_hover_file = savefile.PracticeSaveInfo(morth_hover_requirements, p0, morth_hover_angle, morth_hover_position, morth_hover_cam_pos, morth_hover_cam_target, morth_hover_counter, "morth_hover", p1)
    ...
    ganondorf_counter = 0
    ganondorf_file = savefile.PracticeSaveInfo(ganondorf_requirements, p0, ganondorf_angle, ganondorf_position, ganondorf_cam_pos, ganondorf_cam_target, ganondorf_counter, "ganondorf", p1)
